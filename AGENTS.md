# Agent Guide — ep_padlist2

Etherpad plugin to display a list of pads.
...
`ep_padlist2` runs inside Etherpad's test harness. From an etherpad checkout that has installed this plugin via `pnpm run plugins i --path ../ep_padlist2`:
